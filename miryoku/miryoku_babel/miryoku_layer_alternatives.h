...
&kp C_BRI_DN,      &kp C_BRI_UP,      &kp C_VOL_UP,      U_RGB_BRI,         U_RGB_TOG,         U_NA,              &u_to_U_BASE,      &u_to_U_EXTRA,     &u_to_U_TAP,       U_BOOT,            \
...
U_RGB_EFF,         &kp C_BRI_DN,      &kp C_BRI_UP,         U_RGB_BRI,         U_RGB_TOG,         U_NA,              &u_to_U_BASE,      &u_to_U_EXTRA,     &u_to_U_TAP,       U_BOOT,            \
...
U_BOOT,            &u_to_U_TAP,       &u_to_U_EXTRA,     &u_to_U_BASE,      U_NA,              U_RGB_TOG,         U_RGB_EFF,         &kp C_VOL_UP,      &kp C_BRI_DN,         &kp C_BRI_UP,         \
...
U_BOOT,            &u_to_U_TAP,       &u_to_U_EXTRA,     &u_to_U_BASE,      U_NA,              U_RGB_EFF,         &kp C_BRI_DN,         &kp C_BRI_UP,         U_RGB_BRI,         U_RGB_TOG,         \
